#include "drv_AS62.h"
 /*配置程序if( ASxx_Write_OK == Read_Buff[ 0 ] )
		{
			ASxx_read_param( Read_Buff );
			for( i = 0; i < 6; i++ )
			{
...
uint8_t g_ASxx_Param_Config[ 6 ] = { 0xC0, 0x12, 0x35, 0x1A, 0x17, 0x44 };//固定格式，HADDR,LADDR,SPEED，9600BAUD,433M,
